...
${plantDesc}`;
    ...
    try {
        ...
        // 529 = API overbelastet — vent 1 sek og prøv én gang til
        ...
        if (result.status !== 200) {
            ...
            return { statusCode: 200, body: JSON.stringify({ info: `Anthropic er overbelastet lige nu – prøv igen om et øjeblik.` }) };
        }
